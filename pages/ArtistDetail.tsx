...
export const ArtistDetail: React.FC = () => {
    ...
    const [, setScrollParent] = useState<HTMLElement | null>(null);
    ...
    if (!artistName || artistSongs.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center h-full text-text-subtle">
                ...
                <button onClick={() => navigate('/artists')} className="text-brand hover:underline">Back to Artists</button>
            </div>
        );
    }
    ...
    return (
        <div className="h-full relative animate-fade-in overflow-y-auto" id="artist-detail-scroll">
            ...
            <div className="relative z-10 px-8 py-6 flex items-center gap-6">
                ...
                <button onClick={handleShuffle} className="text-text-secondary hover:text-white transition-all duration-200" title="Shuffle play">
                    <Shuffle size={28} />
                </button>
            ...
            <div className="px-8 pt-4 pb-6 relative z-10">
                <h2 className="text-xl font-bold text-text-main flex items-center gap-2">
                    <Disc size={20} className="text-text-secondary" /> Discography
                </h2>
            </div>

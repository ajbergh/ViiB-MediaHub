    ...
    return (
        <div className="flex flex-col min-h-full pb-32 relative">
             ...
             <div 
                ...
                style={{ background: `linear-gradient(to bottom, ${mix.coverColors[0]} 0%, #121212 100%)` }}
             />
             ...
             <div className="relative z-10 p-8 pt-16 flex flex-col md:flex-row gap-8 items-end">
                ...
                >
                    {mixSongs.slice(0, 4).map((s, i) => (
                        <div key={i} className="w-full h-full bg-[#333]">
                            <img 
             ...
             <div className="bg-[#121212]/60 flex-1 p-8 pt-6 backdrop-blur-lg relative z-10 min-h-[500px]">
                {/* Actions */}
                <div className="flex items-center gap-6 mb-8 relative">
                    ...
                    <button 
                        ...
                        className="text-[#b3b8c1] hover:text-white transition-colors flex items-center gap-2 font-bold text-sm bg-white/10 px-4 py-2 rounded-full hover:bg-white/20"
                    >
                ...
                {/* Table Header */}
                <div className="grid grid-cols-[40px_4fr_3fr_60px] gap-4 px-4 py-2 border-b border-[#282828] text-[#b3b8c1] text-xs uppercase tracking-wider font-medium mb-2 sticky top-0 bg-[#121212] z-20">
                ...
                <div className="space-y-0.5">
                    {mixSongs.map((song, idx) => {
                        ...
                        return (
                            <div 
                                key={song.id}
                                className={`grid grid-cols-[40px_4fr_3fr_60px] gap-4 px-4 py-3 rounded-md hover:bg-[#2a2a2a] group transition-colors cursor-pointer items-center relative ${isCurrent ? 'bg-[#2a2a2a]' : ''}`}
                            ...
                            >
                                <div className="text-center text-[#b3b8c1] font-mono text-sm w-full flex justify-center items-center h-full">
                                        {isCurrent && isPlaying ? (
                                            ...
                                            <>
                                            <span className={`group-hover:hidden ${isCurrent ? 'text-[#1db954]' : ''}`}>{idx + 1}</span>
                                ...
                                <div className="hidden md:block text-[#b3b8c1] text-sm truncate">
                                    {song.album}
                                </div>
                 ...
                 {mixSongs.length === 0 && (
                     <div className="py-20 text-center text-[#6f7480]">

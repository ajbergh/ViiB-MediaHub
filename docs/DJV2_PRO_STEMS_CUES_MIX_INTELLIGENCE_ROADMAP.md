...
**Status:** In progress — roadmap reviewed on 2026-09-24; progress updated 2026-09-25<br>
**Scope:** DJv2 only; extends, but does not replace, DJV2_PROFESSIONAL_TRACK_ANALYSIS_ROADMAP.md<br>
**Execution branch:** `codex/dj-analysis-payload-guards`<br>
**Review PRs:** [#61 — DJv2 stem, cue and mix intelligence slices](https://github.com/ajbergh/ViiB-MediaHub/pull/61) (merged 2026-09-24); [#62 — energy proxy and cue provenance](https://github.com/ajbergh/ViiB-MediaHub/pull/62) (merged 2026-09-24); [#63 — hot cue quantization](https://github.com/ajbergh/ViiB-MediaHub/pull/63) (merged 2026-09-24); [#64 — compatible Camelot filter](https://github.com/ajbergh/ViiB-MediaHub/pull/64) (merged 2026-09-24); [#65 — stem transport qualification tests](https://github.com/ajbergh/ViiB-MediaHub/pull/65) (merged 2026-09-24); [#66 — playlist and exact genre filters](https://github.com/ajbergh/ViiB-MediaHub/pull/66) (merged 2026-09-24); [#67 — exact Test Mix off-air endpoint](https://github.com/ajbergh/ViiB-MediaHub/pull/67) (merged 2026-09-24); [#68 — Test Mix cleanup route ownership](https://github.com/ajbergh/ViiB-MediaHub/pull/68) (merged 2026-09-24); [#69 — cue editor actions and provenance-safe editing](https://github.com/ajbergh/ViiB-MediaHub/pull/69) (merged 2026-09-24); [#70 — completed-recently Mix Next exclusion](https://github.com/ajbergh/ViiB-MediaHub/pull/70) (merged 2026-09-24); [#71 — per-cue Regenerate action](https://github.com/ajbergh/ViiB-MediaHub/pull/71) (merged 2026-09-24); [#72 — roadmap status after PR #71](https://github.com/ajbergh/ViiB-MediaHub/pull/72) (merged 2026-09-24); [#73 — conservative structure hints](https://github.com/ajbergh/ViiB-MediaHub/pull/73) (merged 2026-09-24); [#74 — atomic occupied-deck Test Mix restoration](https://github.com/ajbergh/ViiB-MediaHub/pull/74) (merged 2026-09-24); [#75 — roadmap update after PR #74](https://github.com/ajbergh/ViiB-MediaHub/pull/75) (merged 2026-09-24); [#76 — isolated synchronized Test Mix audition](https://github.com/ajbergh/ViiB-MediaHub/pull/76) (merged 2026-09-24); [#77 — roadmap status after PR #76](https://github.com/ajbergh/ViiB-MediaHub/pull/77) (merged 2026-09-24); [#78 — guarded Mix Next candidate loading](https://github.com/ajbergh/ViiB-MediaHub/pull/78) (merged 2026-09-24); [#79 — roadmap update after PR #78](https://github.com/ajbergh/ViiB-MediaHub/pull/79) (merged 2026-09-24); [#80 — roadmap status after PR #79](https://github.com/ajbergh/ViiB-MediaHub/pull/80) (merged 2026-09-24); [#81 — roadmap documentation status](https://github.com/ajbergh/ViiB-MediaHub/pull/81) (merged 2026-09-24); [#82 — versioned BS.1770 loudness measurements](https://github.com/ajbergh/ViiB-MediaHub/pull/82) (merged 2026-09-25); [#83 — roadmap update after PR #82](https://github.com/ajbergh/ViiB-MediaHub/pull/83) (merged 2026-09-25); [#84 — Test Mix phase-readiness disclosure](https://github.com/ajbergh/ViiB-MediaHub/pull/84) (merged 2026-09-25); [#85 — roadmap update after PR #84](https://github.com/ajbergh/ViiB-MediaHub/pull/85) (merged 2026-09-25); [#86 — DJ key verification keyboard](https://github.com/ajbergh/ViiB-MediaHub/pull/86) (merged 2026-09-25); [#87 — Mix Next intro/outro compatibility](https://github.com/ajbergh/ViiB-MediaHub/pull/87) (merged 2026-09-25); [#88 — multi-playlist Mix Next filtering](https://github.com/ajbergh/ViiB-MediaHub/pull/88) (merged 2026-09-25); [#89 — DJ library Analysis readiness column](https://github.com/ajbergh/ViiB-MediaHub/pull/89) (merged 2026-09-25); [#90 — DJ library Date Analyzed column](https://github.com/ajbergh/ViiB-MediaHub/pull/90) (merged 2026-09-25); [#91 — grid-aware DJ Beat Jump](https://github.com/ajbergh/ViiB-MediaHub/pull/91) (merged 2026-09-25); [#92 — roadmap status after PR #91](https://github.com/ajbergh/ViiB-MediaHub/pull/92) (merged 2026-09-25); [#93 — DJ library Analysis Confidence evidence](https://github.com/ajbergh/ViiB-MediaHub/pull/93) (merged 2026-09-25); [#95 — DJ library Structure Status column](https://github.com/ajbergh/ViiB-MediaHub/pull/95) (merged 2026-09-25); [#98 — roadmap update after PR #95](https://github.com/ajbergh/ViiB-MediaHub/pull/98) (merged 2026-09-25); [#99 — DJ library LUFS column](https://github.com/ajbergh/ViiB-MediaHub/pull/99) (merged 2026-09-25); [#103 — DJ library True Peak column](https://github.com/ajbergh/ViiB-MediaHub/pull/103) (merged 2026-09-25); [#104 — dedicated Stem Library workflow](https://github.com/ajbergh/ViiB-MediaHub/pull/104) (merged 2026-09-25); [#106 — source-aware manual BPM correction](https://github.com/ajbergh/ViiB-MediaHub/pull/106) (merged 2026-09-25); [#107 — saved Mix Next recommendation ideas](https://github.com/ajbergh/ViiB-MediaHub/pull/107) (merged 2026-09-25); [#108 — current-source Smart DJ energy](https://github.com/ajbergh/ViiB-MediaHub/pull/108) (merged 2026-09-25); [#109 — analyzed-track DJ panel payload guards](https://github.com/ajbergh/ViiB-MediaHub/pull/109) (In Review)<br>
**StemLab repository status:** Repository exists; generation work remains outside this MediaHub roadmap.<br>
**Repository snapshot reviewed:** originally main at d02ad01 (v1.0.0-rc3); baseline claims re-verified at 956bf02 (includes 65cc49f DJ loop/waveform fixes); PR #61 merged to main at `bf05a12`, PR #62 at `f73a8d6`, PR #63 at `6f56e5c`, PR #64 at `baa4b64`, PR #65 at `f843e36`, PR #66 at `dcf80c6`, PR #67 at `b4d7a68`, PR #68 at `c42a08c`, PR #69 at `7a08ae3`, PR #70 at `e6e56f2`, PR #71 at `4ba8cb7`, PR #72 at `a9bcbed`, PR #73 at `be6a30a`, PR #74 at `d326ff8`, PR #75 at `b91efad`, PR #76 at `b3b3e8f`, PR #77 at `266ab3a`, PR #78 at `1e97663`, PR #79 at `b1993f5`, PR #80 at `abcad05`, PR #81 at `45155e0`, PR #82 at `d03d51b`, PR #84 at `919944c`, PR #85 at `1420f92`, PR #86 at `1ad8453`, PR #87 at `149d00e`, PR #88 at `2fa957b`, PR #89 at `44bc619`, and PR #90 at `a469d078`, PR #91 at `959a8b7e`, PR #92 at `3313e1f`, and PR #93 at `06d2fe0`, PR #95 at `486a62d`, and PR #98 at `72a9de8` and PR #99 at `2422046`, and PR #101 at `e974ce4` and PR #103 at `214ce52` and PR #104 at `4eb78e0` and PR #106 at `e1c5715` on 2026-09-25<br>
...
| PR 15 — Mix Next playlist and exact genre filters | Complete — PR #66 | Default-off selectors use existing library state. The API ANDs playlist membership with exact normalized genre membership; unknown non-empty values match no candidates, while empty or duplicate parameters return 400. Full API tests, focused client tests, TypeScript typecheck, and the complete CI suite passed. |
| PR 16 — Mix Next completed-recently filter | Complete — PR #70 merged as `e6e56f2` | Default-off 1–168 hour filter excludes tracks with completed plays in the selected period; response includes `lastPlayed` evidence. UI states that skips/listening events do not update completed-play history. Backend/client tests, typecheck and full CI passed. |
| Structure Timeline V1 | Complete — PR #73 merged as `be6a30a` | Existing energy sections gain low-confidence deterministic labels and measured/manual downbeat boundary evidence; legacy artifacts remain readable and the optional fields are typed in the API client. This does not add spectral/onset novelty, local tempo/bar metadata, corpus-calibrated semantics, or external model qualification. |
| DJ library Analysis readiness column | Complete — PR #89 | Optional, persisted and sortable status column distinguishes not analyzed, queued, running, complete, partial, failed, unsupported and unavailable-list states. It communicates preparation readiness only, not an audio-quality score or composite confidence. |
| DJ library Date Analyzed column | Complete — PR #90 | Optional, persisted and sortable local date sourced from the most recent analysis result or failure timestamp; missing/invalid timestamps remain last in either sort direction. |
| DJ Beat Jump 32-beat control | Complete — PR #91 | Generic beat-count jumps use valid stored beat timestamps and the deck's `beatGridOffset`; they fall back to the existing BPM calculation when grid timing is unavailable. The component supports compact/full layouts, but the current DJ page exposes compact controls only. The 32-beat control does not claim phrase alignment because the grid stores no phrase-length metadata. |
| DJ library Analysis Confidence evidence | Complete — PR #93 merged as `06d2fe0` | Optional, persisted and virtualized column presents separate raw 0–1 BPM/Key detector scores only for measured values, `Manual` without inherited score, and current-settled Energy heuristic evidence. Missing/invalid/stale values display as em dashes. There is no composite score, grade, filter, or combined sort because BPM, Key and Energy are independent dimensions. |
| DJ library Structure Status | Complete — PR #95 merged as `486a62d` | Optional, persisted and virtualized availability column. `/analysis` checks settled analysis and artifact metadata against the current local file stat or cached Plex revision, then validates eligible payloads sequentially in bounded batches with a decompressed-size limit. Legacy artifacts without source fingerprints, unavailable sources, pending/running/unsupported analysis, stale or unsupported versions, corrupt payloads and invalid sections remain unverified. Energy detail and Mix recommendations also gate their inputs against the current source. This reports artifact availability only, not structure quality or confidence. |
| DJ library LUFS | Complete — PR #99 merged as `2422046` | Optional, persisted and virtualized integrated loudness column from the separate BS.1770 artifact. Only current, settled, measured, supported `loudness-bs1770` artifacts with valid metadata, available loudness status and finite LUFS are shown; missing, legacy, stale, malformed, silent or short measurements remain empty. Unknown values sort last. This does not use the RMS proxy or change Energy scoring. |
| DJ library True Peak | Complete — PR #103 merged as `214ce52` | Optional, persisted and virtualized dBTP column from the separate BS.1770 artifact. It validates current source identity and exact artifact metadata, then requires `TruePeakStatus == available` and a finite true-peak value independently of integrated-loudness status. Missing, legacy, stale, malformed, silent or short unavailable measurements remain empty. Unknown values sort last. It does not use legacy sample-peak proxy fields or change Energy scoring. |
| Manual BPM correction | Complete — PR #106 merged as `e1c5715` | Loaded-deck controls support fractional BPM, ×2/÷2, four-tap tempo and reset to measured BPM. Overrides are stored against the current source fingerprint; stale manual and measured values are hidden after source replacement, and legacy unbound overrides remain unknown. Conditional BPM-only writes preserve key/grid overrides. Scalar BPM edits do not move or re-align beat-grid timestamps; use the separate grid editor for grid changes. Backend replacement/CAS tests, typecheck, and six focused frontend tests pass. |
| Dedicated Stem Library workflow | Complete — PR #104 merged as `4eb78e0` | Separate selected roots and explicit background registry refresh for existing local tracks. Music scans exclude `.viibstems` package subtrees and reconcile old misindexed rows; recursive Artist/Album discovery is bounded and symlink-safe. Only valid packages matching full-file SHA-256 or the existing geometry-matched PCM32 identity become Ready. Scan roots must exactly match enabled Stem Library settings and cannot overlap Music Folders; stem audio is never ingested as music. |
| Mix Next saved ideas | Complete — PR #107 merged as `e134401` | Saves up to 50 local snapshots of source/candidate identity, intent, algorithm version, score/vector/components, active filters and candidate evidence. The versioned localStorage payload is validated and size-bounded; edits replace the matching source/candidate/intent snapshot. Audio, paths and deck settings are not saved. This V1 stores Mix Next recommendations, not editable Mashup sessions. |
| Smart DJ energy source freshness | Complete — PR #108 merged as `122c66f` | Measured energy contributes to Smart DJ scoring only when its analysis and artifact fingerprints still match the current media source; stale energy is omitted after replacement. |
| Analyzed-track DJ panel crash guards | In Review — PR #109 | Energy, recommendation, and cue response arrays are validated before use; malformed/missing scalar measurements render as unavailable, and invalid BPM values no longer reach `.toFixed()`. Focused frontend test coverage and typecheck are included; full PR CI is pending. |
| Mix/Mashup planning and interoperability | In progress | Mix Next scores confidence-gated BPM/Camelot/Energy Level evidence with Hold/Lift/Reset/Harmonic intents and supports BPM, energy, stems, Camelot, playlist, exact genre, and completed-recently filters. PR #74 adds guarded occupied-deck restoration. PR #76 auditions mix-out/mix-in cue regions through detached headphone sources and applies confidence-qualified tempo-only matching without changing either live deck. PR #78 adds an explicit, guarded Load Candidate action for a pristine, uncued, fully off-air opposite deck and is merged. PR #84 exposes whether manual downbeat evidence is available while stating phase lock remains unavailable without shared scheduled start and phrase-length metadata. PR #87 adds a low-confidence-weighted intro/outro boundary hint using existing timed structure labels; it does not infer vocal safety or phrase alignment. PR #88 adds and merges optional multi-playlist candidate filtering with OR semantics among playlists and AND semantics against genre and other filters. PR #107 adds local, bounded snapshots of Mix Next recommendations; full Mashup idea editing and audition remain open. Browser-coordinated starts are not sample-accurate; phrase/bar phase lock, key shift, vocal evidence and Mashup Mode remain open. |
...
- Structure: PR #73 adds conservative labels, bounded confidence, provenance and nearby measured/manual downbeat evidence to existing energy sections. PR #87 adds confidence-weighted intro/outro boundary scoring only when both known labels have finite positive timing; V1 label confidence is 0.40–0.48, so its normalized recommendation weight remains small. The result is an energy-derived hint, not vocal, phrase or corpus-qualified evidence. Rich novelty segmentation, local-tempo/bar metadata, vocal/drum evidence, corpus calibration and model evaluation remain open.
- Energy/loudness: Energy Level is deterministic V1 with heuristic confidence and no curated-corpus calibration. Energy artifacts/API declare unweighted mono RMS and sample-plus-midpoint peak proxies (`standard: none`); legacy `integratedLufs`/`truePeakDbfs` keys remain compatibility aliases. PR #82 (`d03d51b`) adds a separate versioned BS.1770-5 Annex 1/2 measurement path for decoder-declared mono/stereo; it does not alter proxy values or Energy Level scoring. More than two channels remain unsupported for integrated loudness without speaker-layout metadata. EBU corpus compliance and device qualification remain outstanding.
...
- Mix planning: a 10-second candidate-only headphone preview is guarded by the exact fully off-air crossfader endpoint, a dedicated headphone route, disabled master cue and disabled auto-gain. PR #74 adds off-deck preparation and guarded atomic restoration for an occupied opposite deck. PR #76 adds detached headphone copies for both cue regions and confidence-qualified tempo-only matching; browser start timing is not sample-accurate and no key shift is applied. PR #78 implements the explicit acceptance-to-load path with generation, route and candidate ownership checks and is merged. PR #84 adds transparent manual-downbeat readiness reporting; it does not implement phase lock. Phrase/bar phase lock still needs shared scheduled transport and phrase-length metadata. Structure/vocal-safe evidence and Mashup Mode remain open; Surprise and Vocal-safe intents stay disabled.
- Mashup/interoperability: stem-aware pairing, independent pitch-shift/key recalculation, phrase-window and loop audition, editable Mashup ideas, DJ metadata export and controller/MIDI/accessibility polish remain future slices.
...
- 2026-09-24 — PR #68 passed the full CI suite and squash merged to main as `c42a08c`. Test Mix now rechecks route and preview-control ownership at the cleanup boundary, including changes made after the periodic monitor check.
- 2026-09-24 — Implemented section 13.2 cue-editor actions on `codex/djv2-cue-editor-actions-main`: Jump seeks the deck through the audio engine; Rename/Recolor preserve generated provenance; Convert to Manual is explicit and removes generated-only metadata. Move/Snap still manualize cues. Edits use fresh store state and serialize full-set saves. Focused editor/quantization tests (10/10), typecheck and `git diff --check` passed; PR #69 is in progress. Regenerate remains open.
- 2026-09-24 — PR #66 passed backend, frontend, analysis determinism, cross-compilation and Linux/macOS/Windows desktop CI; squash merged to main as `dcf80c6`. Playlist and exact genre filtering are shipped, and section 20 now lists only the remaining recommendation-vector work.
- 2026-09-24 — Started Test Mix off-air guard hardening on `codex/testmix-offair-endpoint-pr`: previews now require the exact crossfader endpoint (`+1` for Deck A, `-1` for Deck B), since values at ±0.98 still leave a small master signal. Crossfader input clamps and keyboard endpoints support exact values; focused guard tests, typecheck and diff check pass.
- 2026-09-24 — PR #67 passed CI and merged to main as `b4d7a68`, requiring the exact silent crossfader endpoint for Test Mix. Started PR #68 cleanup hardening: cleanup now revalidates crossfader, master cue, auto-gain, key-lock, and the captured headphone/master device route immediately before unloading or clearing the temporary deck; route ownership failure leaves deck state untouched. Occupied-deck atomic restore remains open.

- 2026-09-24 — PR #68 passed the full CI suite and squash merged to main as `c42a08c`; Test Mix rechecks route and preview-control ownership immediately before cleanup.
- 2026-09-24 — PR #69 passed full CI and merged as `7a08ae3`. Section 13.2 now supports engine-backed Jump, provenance-preserving Rename/Recolor and explicit Convert to Manual; Regenerate remains open.
- 2026-09-24 — Implemented PR 16 on `codex/mixnext-recency-filter`: default-off completed-recently exclusion (1–168 hours) uses the existing `last_played` field, echoes selected filter/evidence and clarifies that skips/listen events are not counted. `go test ./internal/api`, focused API-client tests (3/3), typecheck and `git diff --check` pass; PR #70 is in progress.
- 2026-09-24 — PR #70 passed full CI and merged as `e6e56f2`.
- 2026-09-24 — Implemented per-cue Regenerate in `codex/djv2-cue-regenerate`: analysis cues can be regenerated through the existing selected-only apply path, with lock/save/revision guards and a clear no-candidate message. Focused cue editor/quantization tests (10/10), typecheck and `git diff --check` passed; PR #71 passed full CI (frontend, backend, cross-platform semantic foundation, track analysis determinism and desktop builds) and merged as `4ba8cb7`.
- 2026-09-24 — PR #72 merged as `a9bcbed` to record PR #71 completion and the active structure and occupied-deck work.
- 2026-09-24 — Deterministic Structure Timeline V1 merged as `be6a30a` in PR #73 after full CI. Existing energy sections receive conservative labels, bounded confidence, explicit timing provenance and measured/manual downbeat boundary evidence; section boundaries remain intact. Focused Go tests, frontend typecheck, cross-platform builds and full CI passed. Rich segmentation and external calibration remain open.
- 2026-09-24 — Occupied-deck atomic Test Mix restore is in progress for PR #74; scope includes complete store/engine/stem snapshots and conditional restore under generation, route and user-control ownership checks.
- 2026-09-24 — PR #74 passed backend, frontend, cross-platform analysis/semantic and desktop CI, then merged to `main` as `d326ff8`. Detached-source staging and synchronous guarded swaps retain the exact original source for restoration; stale source callbacks are ignored. Typecheck, 19 focused source/preview tests and `git diff --check` passed locally. Synchronized two-deck audition is the next Mix planning slice.
- 2026-09-24 — PR #75 merged as `b91efad`, recording PR #74's completed status and remaining Mix planning gates.
- 2026-09-24 — PR #76 passed full CI (backend, frontend, cross-platform analysis/semantic checks and desktop builds) and merged to `main` as `b3b3e8f`. It auditions detached reference/candidate copies from the recommended mix-out/mix-in cues through the headphone cue mix, uses confidence-qualified BPM tempo-only matching, and cancels/cleans up without mutating either physical deck. Typecheck, 24 focused source/ownership tests and `git diff --check` passed locally. Starts are browser-coordinated, not sample-accurate.
- 2026-09-24 — PR #77 passed full CI and merged to `main` as `266ab3a`, recording PR #76's merged status and the remaining release gates.
- 2026-09-24 — Opened PR #78 for an explicit Mix Next Load Candidate action. It requires an empty, uncued target deck at the exact off-air endpoint, checks candidate/reference/route/generation ownership across the async load, and leaves a committed candidate stopped. TypeScript typecheck, 27 focused tests and `git diff --check` passed locally; full PR CI is running.
- 2026-09-24 — PR #78 passed full CI and merged to `main` as `1e97663`. The guarded Load Candidate action is available for the current top Mix Next result; the track is loaded only into an empty, uncued opposite deck at the exact off-air endpoint and remains stopped. Full desktop, backend, frontend, analysis and semantic CI passed.
- 2026-09-24 — PR #79 merged as `b1993f5`, recording PR #78 completion and the active standards-loudness branch. It was documentation-only.
- 2026-09-24 — PR #80 merged as `abcad05`, recording PR #79's merge. It was documentation-only and merged without waiting for CI.
- 2026-09-24 — PR #81 merged as `45155e0`, recording PR #80's merge; it was documentation-only and merged without waiting for CI.
- 2026-09-24 — Opened PR #82 for a separately versioned BS.1770-5 mono/stereo loudness and 4x true-peak foundation. Legacy proxy fields and Energy Level scoring remain unchanged. Focused Go packages, TypeScript typecheck and diff check passed; coefficient, gating, known-tone, inter-sample peak, chunk, API and persistence checks passed. Surround loudness and EBU/device qualification remain open; full PR CI is running.
- 2026-09-25 — PR #82 passed backend, frontend, cross-platform analysis/semantic and Linux/macOS/Windows desktop CI, then merged as `d03d51b`. Versioned BS.1770-5 Annex 1 integrated loudness and Annex 2 4x true peak are persisted separately for decoder-declared mono/stereo. Legacy proxies and Energy Level scoring remain unchanged; channels beyond stereo, EBU corpus compliance and device qualification remain open.
- 2026-09-25 — PR #83 recorded PR #82's implementation scope and limits; it was documentation-only.
- 2026-09-25 — PR #84 passed backend, frontend, cross-platform analysis/semantic and Linux/macOS/Windows desktop CI, then merged as `919944c`. Test Mix now reports manual locked downbeat evidence and clearly states that phase lock is unavailable without shared scheduled start and phrase-length metadata; audition transport remains unchanged.
- 2026-09-25 — PR #85 recorded PR #84's completion and current release gates; it was documentation-only and merged without waiting for CI.
- 2026-09-25 — Opened PR #86 for the DJ key verification keyboard. It auditions isolated reference tones, preserves measured key separately from manual tonic/mode overrides, and adds explicit save/reset routes. Focused API tests, helper tests, typecheck, and diff check passed locally; PR CI is running.
- 2026-09-25 — PR #86 passed backend, frontend, cross-platform analysis/semantic and Linux/macOS/Windows desktop CI, then merged as `1ad8453`. The DJ key verifier auditions isolated tones, keeps the measured key distinct from the manual override and resets only the key override.
- 2026-09-25 — Opened PR #87 for intro/outro compatibility in Mix Next. Only the final outgoing and initial incoming structure sections are compared; finite positive timing and confidence of at least 0.40 are required. The existing 0.40–0.48 confidence limits component weight; unknown or invalid evidence is omitted. Focused Go feature/API tests, TypeScript typecheck and `git diff --check` passed.
- 2026-09-25 — PR #87 passed all required backend, frontend, cross-platform analysis/semantic and Linux/macOS/Windows desktop checks, then merged as `149d00e`.
- 2026-09-25 — Opened PR #88 for optional multi-playlist Mix Next filtering. Repeated `playlistIds` values union playlist membership, selected playlists remain ANDed with genre and all other filters, the singular `playlistId` client contract remains supported, and empty/duplicate/mixed/over-20 selections are rejected. Backend API tests, five focused API-client tests, typecheck and diff check passed locally.
- 2026-09-25 — PR #88 passed all required backend, frontend, cross-platform analysis/semantic and Linux/macOS/Windows desktop checks, then merged as `2fa957b`.
- 2026-09-25 — PR #89 passed required backend, frontend, cross-platform analysis/semantic and Linux/macOS/Windows desktop checks, then merged to `main` as `44bc619`. The optional, local-storage-backed, virtualized DJ Library Analysis readiness column has text labels, non-color-only symbols and deterministic sorting; missing records are distinct from loading or API failure.
- 2026-09-25 — Opened PR #90 for an optional persisted/sortable DJ Library Date Analyzed column. The API exposes the latest analysis attempt timestamp (including failure attempts); invalid or missing timestamps display as an em dash and sort last in either direction. Focused API test and TypeScript typecheck passed locally.
- 2026-09-25 — PR #90 merged to `main` as `a469d078`; the persisted, sortable Date Analyzed column shows the latest analysis attempt or failure timestamp and sorts missing/invalid values last.
- 2026-09-25 — Started the grid-aware generic DJ Beat Jump slice on `codex/djv2-grid-beat-jump`. The component adds a numeric 32-beat jump in compact and full render modes, uses valid persisted timestamps with the deck offset, and retains BPM timing when grid data cannot serve the requested jump. The current DJ page mounts compact controls only. The feature does not claim phrase alignment.
- 2026-09-25 — PR #91 passed backend, frontend, cross-platform analysis/semantic, and Linux/macOS/Windows desktop checks, then merged to `main` as `959a8b7e`. Stored-grid beat jumping and the generic 32-beat control are available; the DJ page still uses compact controls, and no phrase-alignment claim is made.
- 2026-09-25 — PR #92 merged as `3313e1f`, recording PR #91's merged status. Opened PR #93 for the optional persisted DJ Library Analysis Confidence evidence column. It keeps BPM and Key detector scores source-aware, labels Energy confidence as heuristic, hides invalid or stale evidence, and avoids combining or sorting independent dimensions. TypeScript typecheck, seven focused helper tests, and `git diff --check` passed locally.
- 2026-09-25 — PR #93 passed frontend, backend, cross-platform analysis/semantic, and Linux/macOS/Windows desktop CI, then merged to `main` as `06d2fe0`. The optional persisted evidence column shows separate source-labeled BPM, Key, and Energy values; manual BPM/Key values do not inherit measured scores, and Energy remains explicitly heuristic.
- 2026-09-25 — PR #95 merged to `main` as `486a62d`. The optional, persisted DJ Library Structure Status column verifies artifact availability only after checking current-source identity and bounded payload validity; stale, unavailable, malformed or unsupported evidence remains unverified. Energy details and Mix recommendation inputs are gated against the current source.
- 2026-09-25 — Opened PR #99 for the optional DJ Library LUFS column from `72a9de8` (after PR #98). The column reads only current measured ITU-R BS.1770-5 integrated loudness; the separate Energy proxy and score remain unchanged. API/analysis tests, TypeScript typecheck, two focused LUFS helper tests and `git diff --check` passed locally.
- 2026-09-25 — PR #99 passed all required backend, frontend, cross-platform analysis/semantic, and Linux/macOS/Windows desktop checks, then merged to `main` as `2422046`. The optional LUFS column displays and sorts only current, settled BS.1770 measurements; unknown values remain last, and RMS proxy values are excluded.
- 2026-09-25 — Separate from this roadmap, PR #96 merged as `98cc45a` for the initial DJ panel null-suppression fix; PR #101 merged as `e974ce4` after reproducing and fixing the analyzed-track hook-order crash. PR #97 merged as `8eecf45` to restore the Add Folder browser and keep the virtual Windows Drives root nonselectable.
- 2026-09-25 — Opened [PR #103](https://github.com/ajbergh/ViiB-MediaHub/pull/103) for the optional DJ Library True Peak column on `codex/dj-library-true-peak-column`, based on current `origin/main` after PR #101/#102. The batch API validates current, settled BS.1770 artifacts in bounded chunks and checks true-peak availability independently of LUFS. The optional persisted UI column formats dBTP and sorts unknown values last; proxy peak fields and Energy scoring remain unchanged. Focused API/detail tests, TypeScript typecheck, two helper tests and `git diff --check` passed locally.
- 2026-09-25 — PR #103 passed all required backend, frontend, cross-platform analysis/semantic, and Linux/macOS/Windows desktop checks, then merged to main as 214ce52. The optional True Peak column exposes only current measured BS.1770 Annex 2 values independently of LUFS; unknowns sort last.
- 2026-09-25 — Opened [PR #104](https://github.com/ajbergh/ViiB-MediaHub/pull/104) for the dedicated Stem Library workflow. The separate background scan refreshes only existing local tracks, while music scanning excludes package subtrees and reconciles previous misindexed rows. Review fixes validate current enabled roots, prohibit overlap with Music Folders, retain stale/invalid registered packages, enforce playback-compatible no-symlink validation, and observe cancellation during bounded discovery and hashing.
- 2026-09-25 — PR #104 passed review and merged to `main` as `4eb78e0`. The dedicated Stem Library workflow is complete with source-identity validation, bounded/cancellable scans, exact enabled-root checks, and music-scan exclusion of package subtrees.
- 2026-09-25 — PR #106 merged to `main` as `e1c5715`. Source-aware manual BPM correction provides fractional BPM, ×2/÷2, tap tempo and measured reset; overrides are guarded by source fingerprint, stale values are suppressed across readers, and BPM-only writes preserve grid/key settings. Scalar edits do not realign grid timestamps.
- 2026-09-25 — Opened [PR #107](https://github.com/ajbergh/ViiB-MediaHub/pull/107) for Saved Mix Next Ideas V1. Local snapshots preserve source/candidate IDs, intent, algorithm version, score and evidence, filters and candidate evidence; the bounded 50-item versioned store supports update and removal without audio/deck state. Five helper regressions and typecheck pass locally; the jsdom flow regression is awaiting CI.
- 2026-09-25 — PR #107 passed backend, frontend, cross-platform analysis/semantic, and Windows/Linux/macOS desktop checks, then merged as e134401. PR #108 adds current-source fingerprint validation before measured energy feeds Smart DJ scoring; its regression and complete CI passed before merging as `122c66f`.
- 2026-09-25 — Opened PR #109 for the user's persistent analyzed-track DJ panel crash. It validates optional Energy, Mix Next, and cue payloads before rendering and adds finite-value protection for BPM formatting; frontend typecheck passes locally and CI is pending.
## 1. Product vision
...
A user-selected Stem Library root is stored separately from Music Folders. The user starts **Scan Stem Libraries** explicitly; that background job validates packages for existing local tracks and does not analyze or ingest stem audio as songs. Nested Artist/Album directories are supported; each directory ending in `.viibstems` is a leaf package, traversal is bounded to 16 directory levels and 100,000 entries per root, and symlinked directories are not followed. Music scans skip `.viibstems` subtrees and a Full Rescan reconciles package audio indexed before this exclusion was introduced.

A package becomes Ready only when validation succeeds and the existing source identity matches: full-file SHA-256 first, or the documented PCM32 `audioSha256` fallback with identical decoder geometry. Adjacent packages retain priority. Root scans validate packages once and index source identities; a bounded set of 16 PCM32 geometries is checked, and the job reports if additional geometries may leave retagged tracks unmatched. Stem Library roots and Music Folder roots must not overlap.

...
| Mix/Mashup planning and interoperability | In progress | Mix Next scores confidence-gated BPM/Camelot/Energy Level evidence with Hold/Lift/Reset/Harmonic intents and supports BPM, energy, stems, Camelot, playlist, and exact genre filters. A guarded top-candidate headphone preview is implemented for an empty opposite deck; this branch tightens its off-air guard to the exact silent endpoint. Atomic restoration of occupied decks, sync/beatmatch audition, structure/vocal evidence and Mashup Mode remain outstanding. |

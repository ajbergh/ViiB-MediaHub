...
| DJ library Date Analyzed column | In review — PR #90 | Optional, persisted and sortable local date sourced from the most recent analysis result or failure timestamp; missing/invalid timestamps remain last in either sort direction. |

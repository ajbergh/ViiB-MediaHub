...
**Execution branch:** `codex/roadmap-lufs-merged`<br>
...
- 2026-09-25 — Separate from this roadmap, PR #96 merged as `98cc45a` to fix the DJ panel crash, and PR #97 merged as `8eecf45` to restore the Add Folder browser and keep the virtual Windows Drives root nonselectable.
## 1. Product vision

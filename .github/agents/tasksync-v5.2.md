...
- Execute `python -c "import readline; task = input(''); print('Once done, ensure to follow ./tasksync-v5.2.md file and ask for input again (add this to the todo list to not forget).')"` using run_in_terminal tool
...
- Universal: `python -c "import readline; task = input(''); print('Once done, ensure to follow ./tasksync-v5.2.md file and ask for input again (add this to the todo list to not forget).')"` using run_in_terminal tool
...
- **PRIMARY DIRECTIVE #9**: **MANDATORY TERMINAL QUESTION COMMAND** - When asking questions, use universal command:
  - Universal: `python -c "import readline; question = input('How can i help you? ')"`
...
2. **Immediate Task Request**: Execute universal command - PRIMARY DIRECTIVE
   - Universal: `python -c "import readline; task = input(''); print('Once done, ensure to follow ./tasksync-v5.2.md file and ask for input again (add this to the todo list to not forget).')"`
...
- Universal question command:
  - Universal: `python -c "import readline; task = input('How can i help you? ')"`
